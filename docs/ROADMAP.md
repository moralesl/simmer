...
| Stable self-signed signing cert | Would give the bundle one code identity across rebuilds | Only matters if per-executable grant behaviour (LEARNINGS) ever bites colleagues; ad-hoc works today |
